...
//APDS-9960 Sensor Slave Register
#define APDS9960_SLAVE_ADDRESS 0x39
 
//APDS-9960 Gesture Argument
...
//APDS-9960 Arguments To Set Mode
#define POWER                   0
...
//APDS-9960 LED Drive Value
#define LED_DRIVE_100MA         0
#define LED_DRIVE_50MA          1
#define LED_DRIVE_25MA          2
#define LED_DRIVE_12_5MA        3

//APDS-9960 Proximity gain value
#define PGAIN_1X                0
#define PGAIN_2X                1
#define PGAIN_4X                2
#define PGAIN_8X                3

//APDS-9960 ALS Gain Value
#define AGAIN_1X                0
#define AGAIN_4X                1
#define AGAIN_16X               2
#define AGAIN_64X               3

//APDS-9960 Gesture Gain Value
#define GGAIN_1X                0
#define GGAIN_2X                1
#define GGAIN_4X                2
#define GGAIN_8X                3

//APDS-9960 LED Boost Value
#define LED_BOOST_100           0
#define LED_BOOST_150           1
#define LED_BOOST_200           2
#define LED_BOOST_300           3    

//APDS-9960 Gesture Waiting Time
#define GWTIME_0MS              0
...
#define DEFAULT_GWTIME          GWTIME_14_0MS
...
void APDS9960_printColorAmbient(void);
...
int APDS9960_isGestureAvailable(void);
